...
const vid = 'https://files.catbox.moe/ivtbq2.mp4';

const defaultMenu = {
  before: `
*╭───〔 🌳 Miau 🌸 〕─── *
*│* ¡Hola! %greeting  
*│* Usa *#perfil* para ver tu información personal.
*│* 
*│* 🧭 *Modo:* Público
...
🌿 Usa *#code* para obtener un código de 8 dígitos 🐱
...
let img = 'https://files.catbox.moe/445fzg.jpg'; // valiendo vrg con los links
