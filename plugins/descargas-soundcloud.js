...
let txt = `🥞 *Mira lo que encontré:*\n\n*${results.title}*\n\n⏱️ \`Dura ${results.duration} minutos\`\n🔗 \`Aquí tienes el enlace: ${results.url}\`\n\n> ${dev}`;
...
conn.sendMessage(m.chat, { audio: { url: api2.result.download.url }, mimetype: 'audio/mpeg', ptt: true }, { quoted: m });
